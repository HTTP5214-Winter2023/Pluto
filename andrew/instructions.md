...
Below is preset code for a guitar arpegio effect, which can be played around with.  
Chord parameters can be altered, as well as note sustain,
timing variations, and responsiveness.
